...
<?php 
    ...
    $get_order = $order->get_order_by_id($order_id);

    if($get_order){
        $res2 = $get_order->fetch_assoc();
    }


    if($_SERVER['REQUEST_METHOD'] === "POST") {
        $order_status = $_POST['order_status'];
        $update_order = $order->update_order_status($order_id, $order_status);
    }
?>
        <div class="admin-content-right">
            ...
            <div class="admin-content-right-cartegory-add">
                ...
                <form action="" method="POST">
                    <input type="text" name="order_status" placeholder="Nhập trạng thái đơn hàng" value="<?php echo $res2['order_status'] ?>">
