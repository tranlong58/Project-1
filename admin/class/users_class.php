<?php
    class users {
        ...
        public function show_user(){
            $query = "SELECT * FROM tbl_user, tbl_role WHERE tbl_user.role_id = tbl_role.role_id ORDER BY users_id ASC";
        ...
        public function delete_users($users_id_remove){
            $query = "DELETE FROM tbl_user WHERE users_id = '$users_id_remove'";
